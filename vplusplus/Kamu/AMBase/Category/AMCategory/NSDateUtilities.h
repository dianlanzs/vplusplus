...
static NSString * const D_BII_DATE_Format = @"yyyy-MM-dd";
static NSString * const D_BII_TIME_Format = @"HH:mm:ss";
...
@property (readonly, copy) NSString *weekdayStr;

- (NSDate *) yearsAgo:(NSInteger)years;       //几年前
- (NSDate *) yearsLater:(NSInteger)years;     //几年后
